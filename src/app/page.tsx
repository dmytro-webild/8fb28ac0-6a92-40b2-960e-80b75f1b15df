...
export default function LandingPage() {
      ...
      testimonials={[
        {
          name: "Rohan Kumar",
          handle: "@rohan_k",
          testimonial: "Pawara Diagnostic is truly exceptional. The MRI consultation was thorough, and I felt completely informed throughout the process. Highly recommend their services for accuracy and care.",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-woman-testing-colours_23-2150538710.jpg",
          imageAlt: "Rohan Kumar testimonial image",
        },
        {
          name: "Sneha Devi",
          handle: "@snehadevi",
          testimonial: "The pediatric care for my child was outstanding. Dr. Sheetal made my daughter feel comfortable, and the diagnostic reports were delivered very quickly.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-female-working-nurse_23-2150829831.jpg",
          imageAlt: "Sneha Devi testimonial image",
        },
        {
          name: "Vikram Sharma",
          handle: "@vikramsharma",
          testimonial: "Fast reports and advanced technology! I received my sonography results almost immediately, which helped in timely treatment. Great experience.",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-smiley-woman-clinic_23-2149103560.jpg",
          imageAlt: "Vikram Sharma testimonial image",
        },
        {
          name: "Ananya Rao",
          handle: "@ananyarao",
          testimonial: "The staff is incredibly professional and caring. They patiently explained every step of the CT scan process, easing my anxieties.",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-smiley-doctor-wearing-white-coat_23-2149844582.jpg",
          imageAlt: "Ananya Rao testimonial image",
        },
        {
          name: "Deepak Singh",
          handle: "@deepaksingh",
          testimonial: "Impressed with the efficiency and precision of the X-Ray department. The clinic is well-maintained and very clean. Top-tier medical facility.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-confident-businesswoman-office_329181-19343.jpg",
          imageAlt: "Deepak Singh testimonial image",
        },
      ]}
      avatars={[
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/husband-wife-having-nice-date-cafe_23-2149016156.jpg",
        ...
        {
          src: "http://img.b2bpic.net/free-photo/high-angle-smiley-doctor-explaining-anatomy_23-2149389043.jpg",
          alt: "Patient avatar 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/male-physiotherapist-with-medical-mask-clipboard-checking-woman_23-2148780753.jpg",
      ...
      bulletPoints={[
        {
          ...
          description: "Utilizing state-of-the-art diagnostic equipment for precise results.",
          icon: Activity,
        },
        {
          title: "Expert Care",
          description: "Experienced specialists offering compassionate and reliable healthcare.",
          icon: Heart,
        },
        {
          title: "Patient-Centered",
          description: "Dedicated to a supportive and comfortable experience for every patient.",
          icon: LifeBuoy,
        },
      ]}
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Sonography",
          description: "Advanced ultrasound imaging for precise internal organ visualization.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/ultrasound-scanning-machine-clinic_7502-8370.jpg",
            imageAlt: "Sonography image 1",
          },
          phoneTwo: {
        ...
        {
          title: "Doppler",
          description: "Detailed blood flow studies to assess vascular conditions.",
          phoneOne: {
        ...
        {
          title: "Digital X-Ray",
          description: "High-resolution digital X-rays for skeletal and chest imaging.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/smiling-female-patient-having-abdomen-mri-scan-with-supervision-radiologist-hospital_637285-432.jpg",
            imageAlt: "Digital X-Ray image 1",
          },
          phoneTwo: {
        ...
        },
        {
          ...
          description: "Comprehensive scans for maternal and fetal health during pregnancy.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/pregnant-woman-with-smartphone_23-2147784913.jpg",
            imageAlt: "Obstetric Scan image 1",
          },
          phoneTwo: {
        ...
        {
          title: "CT Scan",
          description: "Computed Tomography for detailed cross-sectional images of the body.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/patient-ready-get-ct-scan-medium-shot_23-2149341500.jpg",
            imageAlt: "CT Scan image 1",
          },
          phoneTwo: {
            imageSrc: "http://img.b2bpic.net/free-photo/mature-woman-medical-technician-hand-xray-scan-hospital-xaxa_637285-509.jpg",
            imageAlt: "CT Scan image 2",
          },
          imageSrc: "http://img.b2bpic.net/free-photo/doctor-getting-patient-ready-ct-scan_23-2149367459.jpg",
          imageAlt: "sonography machine ultrasound scan display",
        },
        {
          title: "MRI Consultation",
          description: "Expert interpretation and guidance for Magnetic Resonance Imaging results.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/doctor-looking-ct-scan_23-2149367428.jpg",
            imageAlt: "MRI Consultation image 1",
          },
          phoneTwo: {
            imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-smiley-doctor-weighing-baby_23-2149728891.jpg",
            imageAlt: "MRI Consultation image 2",
          },
          imageSrc: "http://img.b2bpic.net/free-photo/smiling-doctor-holding-tablet_329181-9260.jpg",
          imageAlt: "sonography machine ultrasound scan display",
        },
        {
          ...
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/doctor-using-tablet-while-hand-is-chin_23-2148285677.jpg",
            imageAlt: "Pediatric Care image 1",
          },
          phoneTwo: {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          name: "Meena Devi",
          handle: "@meenadevi",
          testimonial: "My child's health improved significantly under Dr. Sheetal's care. The clinic provides a very comforting environment for children.",
          imageSrc: "http://img.b2bpic.net/free-photo/doctor-little-girl-laughing_1098-392.jpg",
          imageAlt: "Meena Devi",
        },
        {
          id: "6",
          name: "Rajesh Gupta",
          handle: "@rajeshgupta",
          testimonial: "The entire team is professional and caring. They make complex diagnostic procedures easy to understand and stress-free.",
      ...
      faqs={[
        {
          ...
          content: "Our clinic is open from 09:00 AM – 02:00 PM and 03:00 PM – 08:00 PM, Monday to Saturday. We are closed on Sundays.",
        },
        {
          id: "faq2",
          title: "Do I need an appointment for diagnostic tests?",
          content: "While walk-ins are welcome for some services, we highly recommend booking an appointment to minimize waiting times and ensure our specialists are available.",
        },
        {
          id: "faq3",
          title: "What types of pediatric services do you offer? ",
          content: "We offer comprehensive pediatric care including routine check-ups, vaccinations, treatment for common childhood illnesses, and developmental assessments.",
        },
        {
          id: "faq4",
          title: "How quickly can I get my diagnostic reports?",
          content: "We strive for fast report delivery. Most routine reports are available within 24-48 hours, with urgent cases prioritized. You will be notified when your reports are ready.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      inputs={[
        ...
        },
        {
          ...
          type: "text",
          placeholder: "Service Required (e.g., Sonography, Pediatric Checkup)",
          required: true,
        },
        {
          name: "address",
